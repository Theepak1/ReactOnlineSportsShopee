      ...
      <div>
        <footer class="bg-dark text-center text-white">
          <div class="container p-2">
            ...
            <section class="mb-1">
              <p>
              These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and [capgemini Sports Shopee] (“we,” “us” or “our”), concerning your access to and use of the [capgeminisportsshopee.com] website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”).
              </p>
            </section>
          </div>
